...
@REM python train.py --envs %environments%
@REM python train.py --envs "PongNoFrameskip-v4"
@REM python train.py --envs "BreakoutNoFrameskip-v4"
@REM python train.py --envs "SpaceInvadersNoFrameskip-v4"
@REM python train.py --envs "QbertNoFrameskip-v4"


@REM python transfer.py --env "BoxingNoFrameskip-v4" --load_dir "logs/2024_04_18_15_43_42/model.zip"
@REM python transfer.py --env "BoxingNoFrameskip-v4"
